...
import {sendEmailVerification, signInWithEmailAndPassword,signInWithCredential,fetchSignInMethodsForEmail,OAuthProvider,createUserWithEmailAndPassword} from 'firebase/auth';
...
const SigninPage = () => {
  ...
  const onHandleLogin = (e) => {
    e.preventDefault(); 
    // Remove trailing spaces from the email
